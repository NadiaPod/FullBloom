...
if(!isset($_SESSION['admin']) || $_SESSION['admin'] != true){
	...
	if(mysqli_query($link, "CALL DeleteCategory(".$_GET[delete].");")){
		echo 'Запись удалена.';
		echo "<script>location.replace('showcategories.php');</script>";
	}
	else {
	...
	mysqli_close($link);
		...
		echo "<script>
			...
			if(a==true){
				location.replace('deletecategory.php?id=ok&delete=".$_GET[delete]."');
			}
